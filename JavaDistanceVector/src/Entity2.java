    ...
    // Perform any necessary initialization in the constructor
		...
		public Entity2()
	  {
	    	...
	    	this.printDT();
				...
				Packet packet1 = new Packet(2, 0, this.shortestPath);
				Packet packet2 = new Packet(2, 1, this.shortestPath);
				Packet packet3 = new Packet(2, 3, this.shortestPath);

				// Sends each packet to the specified node i.e. Packet#
				NetworkSimulator.toLayer2(packet1);
				NetworkSimulator.toLayer2(packet2);
				NetworkSimulator.toLayer2(packet3);
