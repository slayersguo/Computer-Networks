public class Entity0 extends Entity
{
  ...
  public Entity0()
  {
	    ...
	    Packet packet1 = new Packet(0, 1, this.shortestPath);
			Packet packet2 = new Packet(0, 2, this.shortestPath);
			Packet packet3 = new Packet(0, 3, this.shortestPath);
